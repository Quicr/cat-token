...
fn test_integer_coord_encoded_as_integer() {
    ...
    let token = CatToken::new().with_geo_coordinate(45.0, 90.0, 0);
...
fn test_fractional_coord_encoded_as_float() {
    ...
    let token = CatToken::new().with_geo_coordinate(45.5, 90.25, 0);
...
fn test_integer_coords_roundtrip() {
    ...
    let token = CatToken::new().with_geo_coordinate(45.0, -90.0, 1000);
